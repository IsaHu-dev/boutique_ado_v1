...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'home', 'templates','allauth'),# Add this line to include the home app templates directory
    ],
        'APP_DIRS':True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_URL='/media/'
MEDIA_ROOT=os.path.join(BASE_DIR,'media') # Add this line to include the media directory
